        ...
        {capabilities.map((w, i) => (
          <SectionReveal key={i} delay={(i % 3) * 0.1}>
            <div
              ...
              style={{
                paddingRight: (i % 3) !== 2 ? 'clamp(0px, 3vw, 48px)' : 0,
                paddingLeft:  (i % 3) !== 0 ? 'clamp(0px, 2vw, 24px)' : 0,
      ...
      <SectionReveal>
        <div className="mt-12 md:mt-16 flex justify-center">
          <Link
            ...
            style={{ fontFamily: 'var(--font-dm-mono)', fontSize: '12px', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'var(--color-ink)', border: '1px solid var(--color-ink)', padding: '16px 32px' }}
          >
            実績を見る →
          </Link>
        </div>
