...
const defaultCapabilities: WorksCapabilityItem[] = [
  { id: '1', section: 'works_capability', num: '', title: 'Web Application',  sub_label: 'UX Design, Frontend, Next.js',          body: '設計から実装まで一貫して担当。UXフローの再構築と情報アーキテクチャの整理から入る。', order: 1 },
  { id: '2', section: 'works_capability', num: '', title: 'Chrome Extension', sub_label: 'Product Design, Extension',              body: 'ブラウザ上の作業フローに溶け込む設計。ノイズを入れずに機能を届ける。', order: 2 },
  { id: '3', section: 'works_capability', num: '', title: 'Internal Tools',   sub_label: 'UI Systems, Workflow',                   body: '使う人が特定できるからこそ、本当に必要なものだけを作れる。業務の文脈を読む設計。', order: 3 },
  { id: '4', section: 'works_capability', num: '', title: 'CMS / WordPress',  sub_label: 'CMS, Information Architecture',          body: 'コンテンツ編集者の視点で構造を設計。管理のしやすさをUXとして考える。', order: 4 },
  { id: '5', section: 'works_capability', num: '', title: 'Automation',       sub_label: 'Workflow Design, API',                   body: '人が判断すべきことと、機械に任せるべきことを切り分ける。自動化の前に、整理がある。', order: 5 },
  { id: '6', section: 'works_capability', num: '', title: 'UI Systems',       sub_label: 'Design System, Component',               body: '一貫性は見た目の話ではない。判断のブレを減らすためのシステムを設計する。', order: 6 },
]
